...
@interface EditEventInformation () <UIScrollViewDelegate,UITextFieldDelegate,RMDateSelectionViewControllerDelegate,UIAlertViewDelegate,UITextViewDelegate,WebserviceProtocolDelegate>
...
@implementation EditEventInformation

- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil EventId:(NSString *)ParamEventIdNew
{
    self = [super initWithNibName:nibNameOrNil bundle:nibBundleOrNil];
    if (self) {
        self.EventId = ParamEventIdNew;
        ...
        dispatch_async(dispatch_get_main_queue(), ^(void){
            ...
            if (self.ServiceCallType == webservicecalltypeDataFetch) {
                ...
                for (id LocalObject in [ParamObjectCarrier objectForKey:@"event"]) {
                    ...
                    self.ANEventTitle.text = [[ParamObjectCarrier objectForKey:@"event"] objectForKey:@"title"];
                    self.ANCompanyname.text = [[ParamObjectCarrier objectForKey:@"event"] objectForKey:@"company_name"];
                    self.ANContactname.text = [[ParamObjectCarrier objectForKey:@"event"] objectForKey:@"contact_name"];
                    self.ANEmailAddress.text = [[ParamObjectCarrier objectForKey:@"event"] objectForKey:@"email_address"];
                    self.ANPhoneNumber.text = [[ParamObjectCarrier objectForKey:@"event"] objectForKey:@"phone"];
                    self.ANGuestNumber.text = @"2";
                    self.ANSignatory.text = [[ParamObjectCarrier objectForKey:@"event"] objectForKey:@"signatory"];
                    self.ANBudget.text = [[ParamObjectCarrier objectForKey:@"event"] objectForKey:@"budget"];
                    self.ANPreferedRoomRate.text = [[ParamObjectCarrier objectForKey:@"event"] objectForKey:@"preferred_room_rate"];
                    self.ANAuxiliaryService.text = [[ParamObjectCarrier objectForKey:@"event"] objectForKey:@"auxiliary_services"];
                    self.ANFromdate.text = [[ParamObjectCarrier objectForKey:@"event"] objectForKey:@"date_from"];
                    self.ANTodate.text = [[ParamObjectCarrier objectForKey:@"event"] objectForKey:@"date_to"];
                    self.ANClosingDate.text = [[ParamObjectCarrier objectForKey:@"event"] objectForKey:@"closing_date"];
                    self.ANContactDate.text = [[ParamObjectCarrier objectForKey:@"event"] objectForKey:@"contract_date"];
                    self.ANEventLocation.text = [[ParamObjectCarrier objectForKey:@"event"] objectForKey:@"location"];
                    self.ANEventRequirements.text = [[ParamObjectCarrier objectForKey:@"event"] objectForKey:@"event_requirements"];
                    self.ANPreferedAlternetLocation.text = [[ParamObjectCarrier objectForKey:@"event"] objectForKey:@"preferred_alternate_location"];
