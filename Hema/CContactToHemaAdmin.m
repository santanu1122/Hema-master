...
@interface CContactToHemaAdmin () <UIScrollViewDelegate,UITextFieldDelegate,UIAlertViewDelegate,UITextViewDelegate,WebserviceProtocolDelegate>
...
@implementation CContactToHemaAdmin
...
-(void)CallWebserviceForData
{
    if (!IS_NETWORK_AVAILABLE())
    {
        ...
        WebserviceProtocol *Datadelegate = [[WebserviceProtocol alloc] initWithParamObject:[UrlParameterString WebParamCustomerContactWithAdmin] ValueObject:self.DataAccessArray UrlParameter:[UrlParameterString URLParamCustomerContactWithAdmin]];
